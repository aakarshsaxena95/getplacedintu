...
<?php 
if($sal==2)
$id="select Bc_id from `btech salary` where Salary<5";
else if ($sal==3)
	$id="select Bc_id from `btech salary` where Salary between 5 and 8";
else 
	$id="select Bc_id from `btech salary` where Salary>=8";
$r2=mysql_query($id);
$l=1;
