...
if($sal==2)
	$id="select `mtech placements`.Mc_id from `mtech placements`,`mtech salary` where `mtech salary`.Mc_id=`mtech placements`.Mc_id and `mtech placements`.Branch='".$br."' and `mtech salary`.Salary<5";
else if ($sal==3)
	$id="select `mtech placements`.Mc_id from `mtech placements`,`mtech salary` where `mtech salary`.Mc_id=`mtech placements`.Mc_id and `mtech placements`.Branch='".$br."' and `mtech salary`.Salary between 5 and 8";
else
	$id="select `mtech placements`.Mc_id from `mtech placements`,`mtech salary` where `mtech salary`.Mc_id=`mtech placements`.Mc_id and `mtech placements`.Branch='".$br."' and `mtech salary`.Salary>8";
$r2=mysql_query($id);
$l=1;
...
{		$cc="select count(Branch) from `mtech placements` where Mc_id='".$row['Mc_id']."'";
		...
		$num="select Number from `mtech placements` where Mc_id='".$row['Mc_id']."' and branch='".$br."'";
		$r5=mysql_query($num);
